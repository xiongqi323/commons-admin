...
;layui.extend({setter: "config", admin: "admin", view: "view"}).define(["setter", "admin"], function (a) {
    ...
    r(window);
    n.screen() < 2 && n.sideFlexible(), layui.config({base: e.base}), layui.each(e.extend, function (a, i) {
        var n = {};
        n[i] = "{/}" + e.base + "extend/" + i, layui.extend(n)
